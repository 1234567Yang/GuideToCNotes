...
badd +14 test_ctf.c
badd +48 tree_traversal_pre_order.c
badd +0 tree_traveersal_pre_order.c
badd +0 btree_del_add.c
badd +0 tree_traversal
badd +0 tree_traversal.c
badd +0 btree_traversal.c
badd +0 hash_table.c
badd +0 hello.c
argglobal
silent! argdel *
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 210 - ((27 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
210
normal! 024|
tabedit hash_table.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
