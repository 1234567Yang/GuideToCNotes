...
badd +11 loop.c
badd +1 vim_notes
badd +1 ~/vim_notes.txt
badd +15 hex_and_oct.c
badd +10 preprocessor.c
badd +1 ~/.vimrc
badd +1 preprocessor.
badd +1 preprocessor2.c
badd +1 preprocessor_str.c
badd +1 fscanf_skip.c
badd +0 printf_str_format
badd +0 printf_str_format.c
argglobal
silent! argdel *
$argadd args.c
set stal=2
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 26 - ((18 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
26
normal! 05|
tabedit preprocessor_str.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 11 - ((9 * winheight(0) + 7) / 15)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
11
normal! 05|
tabedit printf_str_format.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
